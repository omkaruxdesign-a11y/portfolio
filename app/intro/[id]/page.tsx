...
import { companyCaseStudies, getCompanyCaseStudyById } from '@/app/data/caseStudies';
...
export async function generateStaticParams() {
  return companyCaseStudies.map((study) => ({
    id: study.id,
  }));
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const study = getCompanyCaseStudyById(id);
